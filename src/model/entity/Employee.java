...
public class Employee {
    ...
    /**
     * @param deletedFlag "削除"または"未削除"という文字列。
     * 文字列を受け取って対応する数値をdeletedFlagフィールドにセットする。
     */
    public void setDeletedFlag(String deletedFlag) {
        if (deletedFlag.equals("有効")) {
            this.deletedFlag = 1;
        } else if (deletedFlag.equals("無効")) {
            this.deletedFlag = 0;
        }
    }
}
